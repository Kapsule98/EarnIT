        ...
        <div v-for="offer in mapped" :key="offer.length">
          ...
          >
            <div class="couponhome">
              <div class="c2-back">
                <img
                  src="https://images.unsplash.com/photo-1559204260-9d9f024ab30a?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=667&q=80"
                />
              </div>
              <div class="c2-off">
                {{ offer.value }}% on
